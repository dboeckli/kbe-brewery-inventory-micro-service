...
@SpringBootTest(properties = { "sfg.brewery.queues.allocate-order-result=allocate-order-result-test",
...
class AllocationListenerIT {
    ...
    void testAllocationListener() {
        ...
        AllocateBeerOrderRequest request = AllocateBeerOrderRequest.builder()
            .beerOrder(BeerOrderDto.builder().id(orderId).build())
            .build();
                ...
                if (message instanceof TextMessage textMessage) {
                    try {
                        ...
                        if (event.getBeerOrderDto() != null
                                && expectedOrderId.equals(event.getBeerOrderDto().getId())) {
